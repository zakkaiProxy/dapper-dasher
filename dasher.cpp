...
int main()
{
    ...
    //this is how many pixels per second we going to downward velocity per second
    ...
    while (!WindowShouldClose())
    {
        ...
        //Jump check
        //checks if space is pressed and if "not is in air"
